...
nocite: |
  @boot1, @boot2, @data.table, @readxl, @parallel, @doParallel, @kableExtra, @knitr_1, @knitr_2, @cmdstanr, @rstan, @mixtools, @zoolog, @Cairo, @ggplot2, @ggdist, @ggpubr, @ggrepel, @rnaturalearth, @rnaturalearthdata, @sf
---
...
definitions <- data.table(
  ...
  Definition = c('A complete or partial skeletal element defined by the zooarchaeologist, used as the foundation of the multilevel model (e.g., "distal humerus"). Model produces parameter estimates for all defined element portions, so element portions must be non-overlapping. Analogous to "skeletal part type" in Breslawski (2023).',
...
```{r single assemblage simulation stan model fit, include = FALSE, eval = TRUE}
...
```{r multisite simulation stan model fit, include = FALSE, eval = TRUE}
#Multisite Analysis
...
pinarbasi_post <- cmdstanr_extract_samples(pinarbasi_samples)
```
...
#
nw_anatolian_post <- cmdstanr_extract_samples(nw_anatolian_multisite_samples)
```
...
single_assemblage_theta1_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_theta[1]") + labs(title = expression(paste(theta[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_theta2_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_theta[2]") + labs(title = expression(paste(theta[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_theta3_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_theta[3]") + labs(title = expression(paste(theta[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_mu1_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_mu_immature") + labs(title = expression(paste(mu[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_mu2_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_mu_female") + labs(title = expression(paste(mu[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_mu3_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_mu_male") + labs(title = expression(paste(mu[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_sigma1_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_sigma_immature") + labs(title = expression(paste(sigma[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_sigma2_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_sigma_female") + labs(title = expression(paste(sigma[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
single_assemblage_sigma3_plot <- mcmc_trace(single_assemblage_samples$draws(), pars = "grand_sigma_male") + labs(title = expression(paste(sigma[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
#
...
multisite_theta1_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_theta[1]") + labs(title = expression(paste(theta[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_theta2_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_theta[2]") + labs(title = expression(paste(theta[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_theta3_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_theta[3]") + labs(title = expression(paste(theta[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_mu1_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_mu_immature") + labs(title = expression(paste(mu[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_mu2_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_mu_female") + labs(title = expression(paste(mu[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_mu3_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_mu_male") + labs(title = expression(paste(mu[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_sigma1_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_sigma_immature") + labs(title = expression(paste(sigma[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_sigma2_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_sigma_female") + labs(title = expression(paste(sigma[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
multisite_sigma3_plot <- mcmc_trace(multisite_samples$draws(), pars = "grand_sigma_male") + labs(title = expression(paste(sigma[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
#
...
pinarbasi_theta1_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_theta[1]") + labs(title = expression(paste(theta[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_theta2_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_theta[2]") + labs(title = expression(paste(theta[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_theta3_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_theta[3]") + labs(title = expression(paste(theta[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_mu1_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_mu_immature") + labs(title = expression(paste(mu[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_mu2_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_mu_female") + labs(title = expression(paste(mu[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_mu3_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_mu_male") + labs(title = expression(paste(mu[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_sigma1_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_sigma_immature") + labs(title = expression(paste(sigma[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_sigma2_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_sigma_female") + labs(title = expression(paste(sigma[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
pinarbasi_sigma3_plot <- mcmc_trace(pinarbasi_samples$draws(), pars = "grand_sigma_male") + labs(title = expression(paste(sigma[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
#
...
nw_anatolian_theta1_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_theta[1]") + labs(title = expression(paste(theta[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_theta2_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_theta[2]") + labs(title = expression(paste(theta[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_theta3_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_theta[3]") + labs(title = expression(paste(theta[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_mu1_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_mu_immature") + labs(title = expression(paste(mu[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_mu2_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_mu_female") + labs(title = expression(paste(mu[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_mu3_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_mu_male") + labs(title = expression(paste(mu[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_sigma1_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_sigma_immature") + labs(title = expression(paste(sigma[1])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_sigma2_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_sigma_female") + labs(title = expression(paste(sigma[2])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
nw_anatolian_sigma3_plot <- mcmc_trace(nw_anatolian_multisite_samples$draws(), pars = "grand_sigma_male") + labs(title = expression(paste(sigma[3])), y = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
#
